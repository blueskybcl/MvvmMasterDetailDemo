...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("MvvmCross.Binding.Droid.Views.MvxLayoutInflater+PrivateFactoryWrapper2, MvvmCross.Binding.Droid, Version=5.4.2.0, Culture=neutral, PublicKeyToken=null", MvxLayoutInflater_PrivateFactoryWrapper2.class, __md_methods);
	}
	...
	public MvxLayoutInflater_PrivateFactoryWrapper2 ()
	{
		...
		if (getClass () == MvxLayoutInflater_PrivateFactoryWrapper2.class)
			mono.android.TypeManager.Activate ("MvvmCross.Binding.Droid.Views.MvxLayoutInflater+PrivateFactoryWrapper2, MvvmCross.Binding.Droid, Version=5.4.2.0, Culture=neutral, PublicKeyToken=null", "", this, new java.lang.Object[] {  });
	}
